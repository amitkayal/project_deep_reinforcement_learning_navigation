...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, hidden_layers):
        ...
        ======
			...
			hidden_layers (list); List of dimensions of hidden layer
        """
    ...
    def get_optimizer(self):
	    """ This method returns the optimizer used by Agent"""
	    return self.optimizer
		
    def get_hiddden_layers(self):
        """ This method returns list of dimensions of hidden layers"""
        return self.hiddden_layers
